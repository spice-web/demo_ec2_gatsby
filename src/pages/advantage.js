...
const AdvantagePage = () => (
  <Layout>
    ...
    />
    <PageTitle>
      ADVANTAGE<span>選ばれる理由</span>
    </PageTitle>

    <div className="content__wrap content__pd">
      <Wrap>
        <h3 className="sec__ttl">
          成田空港公式駐車場と
          <br className="br_maxmd" />
          比較しても<span className="nowrap">断然サンパーキング成田店が</span>
          <span className="nowrap">便利でおトク！</span>
        </h3>
        <p className="pg--md">
      ...
      <Wrap>
        <h3 className="sec__ttl">
          追加料金なしの明朗会計！
          <span className="nowrap">長期利用は1日わずか220円。</span>
          <span className="sec__ttl--sub text-normal">※10日目以降</span>
        </h3>
        <p className="pg--md">
          基本料金、夜間早朝の出発&到着、予定より早い帰着などによる追加料金はありません。また、高級車、特殊な車、大型SUV、キャンピングカーなど、車種によっての追加料金もありません。帰国日が決まっていなくても長期の場合は10日目以降は1日220円なので、1ヶ月単位で出張や旅行に行かれるお客様に好評です。
        </p>

        <h4 className={styles.headline}>
          駐車場を使うと他の交通機関に比べて
          <span className="nowrap">「高い」と考えていませんか？</span>
        </h4>
        <p className="text-normal text-light mb--sm">
      ...
      <Wrap>
        <h3 className="sec__ttl">
          創業30年以上の<span className="nowrap">最古参人気駐車場。</span>
          <br />
          航空会社との連携も充実
        </h3>
        <div className="flex__wrap--md">
          <p className="pg--md flex-col-2--md txt-jt">
            空港管理会社のNAAや、ANA、JAL、Peach、ZIPAIR、Jetstarなどの航空会社や、JTB、HIS、近畿日本ツーリストなどの大手旅行会社とも連携がとれていて安心。駐車料金でマイルが貯められるのも嬉しいポイント！空港勤務者も多数利用している信頼と安心の駐車場です！
      ...
      <Wrap>
        <h3 className="sec__ttl">
          ...
          <br />
          鍵は専用金庫で保管で
          <span className="nowrap">リレーアタック対策も万全。</span>
        </h3>

        <div className="flex__wrap">
          <p className="pg--md flex-col-2--md txt-jt">
            24時間警備会社が警備をし、また、赤外線センサーによる侵入検知するセキュリティ対策を行っております。また預かった鍵は全て専用の金庫で保管するのでリレーアタック対策も万全です。また夜間に関しては、駐車場の出入り口に施錠する、マイクロバス等を配置して侵入を防ぐ対策がされています。
          </p>
          <div className="flex-col-2--md">
            <StaticImage
              src="../images/advantage/key.jpg"
              alt=""
              style={{ width: "100%" }}
            />
          </div>
      ...
      <Wrap>
        <h3 className="sec__ttl">
          駐車場でありながら<span className="nowrap">洗車は専門店並み。</span>
          <br />
          手洗い洗車受注率98%
        </h3>
        ...
        <div className="flex__wrap mb--md">
          <p className="pg--md flex-col-2--md txt-jt">
            Keeperコーティングの代理店で、有資格者が在籍しているので、駐車場でありながら洗車は専門店レベル。お出かけ中の時間を利用して洗車するので待ち時間もありません。
            また、公式LINEのお友だち登録で洗車無料クーポンや、定期的な割引クーポンもありおトクに利用できます。
          </p>
          <div className="flex-col-2--md">
            <StaticImage
              src="../images/advantage/wash.jpg"
