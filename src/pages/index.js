    ...
    <div className="content__wrap content__pd bg--light-green">
      ...
      <div className={styles.option}>
        <ul className={styles.optionBox}>
          ...
          <StaticImage
            src="../images/top/option01.png" imgClassName={styles.selectImg} alt="迷わない" className={styles.imgBox} />
        </ul>
        <ul className={styles.optionBox}>
          ...
          <StaticImage src="../images/top/option02.png" imgClassName={styles.selectImg} alt="24時間警備体制で安心" className={styles.imgBox} />
        </ul>
        <ul className={styles.optionBox}>
          <li className={styles.textBox}>当日でも<span className="text-pk">窓口で旅行保険に加入</span>できるので安心。</li>
          <StaticImage src="../images/top/option03.jpg" imgClassName={styles.selectImg} alt="成田空港駐車場では最大級の2,000台収容" className={styles.imgBox} />
        </ul>
        <ul className={styles.optionBox}>
          <li className={styles.textBox}>行く時も帰る時も、<span className="text-pk">屋根有り乗降スペース</span>で雨に濡れない!</li>
          <StaticImage src="../images/top/option04.jpg" imgClassName={styles.selectImg} alt="WEB予約だと更に 大幅割引実施中！" className={styles.imgBox} />
        </ul>
        ...
        <ul className={styles.optionBox}>
          ...
          <StaticImage
            src="../images/top/option05.jpg" imgClassName={styles.selectImg} alt="迷わない" className={styles.imgBox} />
        </ul>
        <ul className={styles.optionBox}>
          <li className={styles.textBox}>キーパープロショップだから<span className="text-pk">専門店レベルの洗車クオリティ!</span></li>
          <StaticImage src="../images/top/option06.jpg" imgClassName={styles.selectImg} alt="24時間警備体制で安心" className={styles.imgBox} />
        </ul>
        <ul className={styles.optionBox}>
          ...
          <StaticImage src="../images/top/option07.jpg" imgClassName={styles.selectImg} alt="成田空港駐車場では最大級の2,000台収容" className={styles.imgBox} />
        </ul>
        <ul className={styles.optionBox}>
          ...
          <StaticImage src="../images/top/option08.jpg" imgClassName={styles.selectImg} alt="WEB予約だと更に 大幅割引実施中！" className={styles.imgBox} />
        </ul>
      ...
      <div className="content__inner --md">
        ...
        <ul className="flex__wrap">
          <li className="flex-col-2 flex-col-4--sm mb--md">
            <Link to="/more-information#mile"><StaticImage src="../images/parts/button/point.png" alt="貯めてオトクなマイル・ポイント" /></Link>
          </li>
          <li className="flex-col-2 flex-col-4--sm mb--md">
            <Link to=""><StaticImage src="../images/parts/button/how_pay.png" alt="色々あります。お支払い方法" /></Link>
            </li>
          <li className="flex-col-2 flex-col-4--sm mb--md">
            <Link to="/more-information#voice"><StaticImage src="../images/parts/button/voice.png" alt="届いてます。お客様の声" /></Link>
          </li>
          <li className="flex-col-2 flex-col-4--sm mb--md">
            <Link to="/form#faq"><StaticImage src="../images/parts/button/faq.png" alt="お答えします。Q&A" /></Link>
          </li>
        </ul>
        ...
        <div className="flex-col-3--sm bdr-xs bdr-dark-green mb--sm">
            ...
            <dt className={styles.otherServiceTitle} >洗車・コーティング</dt>
              ...
              <dd className={styles.otherServiceImg}>
                <Link to="/option#coating"><StaticImage src="../images/top/link01.jpg" alt="洗車・コーティングサービス" /></Link>
              </dd>
            </dl>
          </div>
          <div className="flex-col-3--sm bdr-xs bdr-dark-green mb--sm">
            <dl className={styles.otherService}>
              ...
              <dd className={styles.otherServiceImg}>
                <a href="https://www.sunparking.co.jp/narita-insurance.html" target="_blank" rel="noregerrer noopener">
                  <StaticImage src="../images/top/link02.jpg" alt="CHUBB海外旅行保険サービス" />
                </a>
              </dd>
            </dl>
          </div>
          <div className="flex-col-3--sm bdr-xs bdr-dark-green mb--sm">
            ...
            <dt className={styles.otherServiceTitle} >JAF</dt>
              ...
              <dd className={styles.otherServiceImg}>
                <StaticImage src="../images/top/link03.jpg" alt="JAFサービス" />
              </dd>
            </dl>
          </div>
        </div>
