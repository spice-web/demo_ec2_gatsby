...
const AboutPage = () => (
  <Layout>
    <Seo title="SAWAYAKAについて" description="SAWAYAKAの会社概要ページ" />
    <h2 class="headline--title">COMPANY PROFILE<span>会社情報</span></h2>
    <div className="content__wrap content__pd">
      <div className="content__inner --sm">
        <p className="pg--md">株式会社テストは1985年に成田空港利用者用駐車場「SAWAYAKA」を開業し、 地域とともに事業を展開・発展させてまいりました。 創設より、私たちは駐車場を出発地と目的地をつなぐ「心安らぐアクセスポイント」と考え、 駐車システムとサービスの充実に力を注ぎ、地域ナンバーワンのサービス産業を目指してまいりました。 今後も成熟した車社会の中で、お客様をあたたかくお迎えする「港」となるために、 未来のモビリティ･ライフを見つめながら、新たなチャレンジを続けてまいります。</p>
      </div>
