  ...
  <Layout>
    ...
    <div className="content__wrap content__pd">
      <div className="content__inner --md">
        ...
        <h3 className="text-lg text-center text-deep-gr text-bold mb--lg">
          サンパーキング成田店は、
    ...
    <div className={Styles.option}>
      <h3 className="sec__ttl text-regular">
        OPTION SERVICE
        <span className="sec__ttl--sub text-normal mb--md">
          オプションサービス
        </span>
      </h3>
        ...
        <div className={Styles.flex}>
          <div className={Styles.box}>
            ...
            <dl className={Styles.text}>
              ...
              <dd>
                お帰りに合わせてお車をキレイに仕上げてお返しできます。お車の気になる点もご相談ください。
              </dd>
            </dl>
            <Link to="/option" className={Styles.link}>
              詳しく&#9654;&#9654;
            </Link>
          </div>
          <div className={Styles.box}>
            ...
            <dl className={Styles.text}>
              ...
              <dd>
                200Vの普通充電器と、テスラ充電用のデスティネーションチャージングを設置。
              </dd>
            </dl>
            <Link to="/option#electrification" className={Styles.link}>
              詳しく&#9654;&#9654;
            </Link>
          </div>
          <div className={Styles.box}>
            ...
            <dl className={Styles.text}>
              ...
              <dd>
                旅行保険もお任せください。最短1分！お客様の旅の安心のために保険をご用意しています。
              </dd>
            </dl>
            <Link to="/option#insurance" className={Styles.link}>
              詳しく&#9654;&#9654;
            </Link>
          </div>
          <div className={Styles.box}>
    ...
    <div className="content__wrap">
      <div className="content__inner --md">
        ...
        <div>
          ...
          <p className="pg--sm-lgt mb--sm">
            VISA・MasterCard・JCB・AMEX・DinersではWEB予約時にカード決済ができます。カード決済のタイミングはWEBで予約された時点で決済されます。
          </p>
          <div className={Styles.card}>
            ...
            <div className={Styles.box}>
              <StaticImage
                src="../images/price/logo/master.png"
                alt="master card"
              />
            </div>
            <div className={Styles.box}>
              <StaticImage
                src="../images/price/logo/american.png"
            ...
            <div className={Styles.box}>
              <StaticImage
                src="../images/price/logo/diners.png"
                alt="Diners Club"
              />
            </div>
          </div>
        ...
        <div>
          <h4 className="sec__ttl">
            ご来店時は、現金、カード、PayPayなどで
            <span className="nowrap">お支払い可能</span>
          </h4>
          <p className="pg--sm-lgt mb--md">
            JCB・VISA・ダイナース・DC・UFJ・ニコス・MASTER・AMEX・UC・Orico・CF・セゾン・イオン・JAL・TS
            CUBIC・OMC・楽天カード
            ・銀聯カード・PayPayなど、各種決済が可能です。
          </p>
          ...
          <div className={Styles.card_sec}>
            ...
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/nicos.png"
                alt="nicos card"
              />
            </div>
            <div className={Styles.box_sec}>
            ...
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/orico.png"
                alt="orico card"
              />
            </div>
            <div className={Styles.box_sec}>
            ...
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/saison.png"
                alt="saison card"
              />
            </div>
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/aeon.png"
                alt="aeon card"
              />
            </div>
            <div className={Styles.box_sec}>
            ...
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/union.png"
                alt="union card"
              />
            </div>
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/paypay.png"
                alt="paypay card"
              />
            </div>
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/rakuten.png"
                alt="Rakuten card"
              />
            </div>
            <div className={Styles.box_sec}>
            ...
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/life.png"
                alt="Life card"
              />
            </div>
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/jaccs.png"
                alt="Jaccs card"
              />
            </div>
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/cedyna.png"
                alt="cedyna card"
              />
            </div>
            <div className={Styles.box_sec}>
              <StaticImage
                src="../images/price/logo/discover.png"
                alt="discover card"
              />
            </div>
          </div>
        ...
        <p className="pg--sm-lgt mb--md text-center--md">
          提携マイル・ポイントをためるには、料金ご精算時にマイル積算希望の旨をお申し出ください。
          <br className="br_md" />
          ※通常料金でのご利用のみマイル対象となります。
        </p>
        ...
        <div className={Styles.mile}>
          <div className={Styles.box}>
            ...
            <figure>
              <StaticImage
                src="../images/price/logo/mileage.png"
                alt="R edy card"
              />
              <figcaption>
                JAL
          ...
          <div className={Styles.box}>
            ...
            <figure>
              <StaticImage
                src="../images/price/logo/jal_card.png"
                alt="Pay Easy card"
              />
              <figcaption>
                JALカード
          ...
          <div className={Styles.box}>
            ...
            <figure>
              <StaticImage
                src="../images/price/logo/ts_lg.png"
                alt="Yahoo ウォレット"
              />
              <figcaption>
                TS CUBIC
        ...
        <Link to="/more-information" className={Styles.button}>
          更に詳しく
        </Link>
      </div>
    </div>
