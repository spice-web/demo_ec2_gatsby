...
const PolicyPage = () => (
  <Layout>
    ...
    <h2 class="headline--title">POLICY<span>サイトポリシー・プライバシーポリシー</span></h2>

    <div className="content__wrap">
      <div className="content__inner --sm">
        <h3>サイトポリシー・プライバシーポリシー</h3>
        <p>このウェブサイトは株式会社サン・ポート（以下当社といいます）が運営しています。 お客様が当サイトをご利用になる際に、前もってご了解いただきたいことや参考になることを説明します。</p>
        ...
        <h3>プライバシーポリシー</h3>
        <p className="text-right">制定　2005年4月1日<br />株式会社サン・ポート</p>
        <p>株式会社サン･ポート（以下，弊社といいます）は，常にお客様へのサービス向上に取り組んでおります。お客様から弊社へ提供される情報は弊社がお客様によりよい商品・サービスを提供させていただくためにのみ使用されます。また，下記の通り情報保護方針を定め，個人情報の保護に努めます。</p>
