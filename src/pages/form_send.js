  ...
  <Layout>
    ...
    <div className="content__wrap content__pd">
      <div className="content__inner --sm">
        ...
        <p className="text-center text-xs mb--lg">必須の欄は必ずご記入の上お問い合わせください。<br className="br_maxsm" />漢字・カナは全角、半角数字、半角ハイフンをご使用ください。</p>
        ...
        <div className="content__inner--xs">
          ...
          <form onSubmit={onSubmit} method="POST" action="/api/send">
            ...
            <div className={styles.checkbox}>
              <input type="checkbox" name="agreement" id="agreement" required onChange={handleChange} />
