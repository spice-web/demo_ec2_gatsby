...
const PriceChart = () => {
  ...
  return (
    <>
      <div className="price-chart__wrap price-page">
        <div className="price-chart--sub">
          ...
          {prices.map(e => (
            <dl className="flex__wrap text-center price-chart__row">
              ...
              <dd className="bdr-white text-md flex-col-3 bg--light-gray text-pk price--sale text-medium">{e.node.sale}<span className="en">円</span></dd>
            </dl>
          ))}
        </div>
    </div>

    <p className="note--sub text-xxs mb--lg">※表示価格は税込みです。10/8、12/29～1/1ご入庫分は繁忙期料金1,000円（税込1,100円）が別途加算されます。<br />
    【ご注意】◎本キャンペーンの料金は公式サイトからのWeb予約限定となります。◎キャンペーン料金でご利用の場合、マイル積算、他の割引券利用はできません。※通常料金でご利用の場合は、受付時、お申し出により提携マイルが積算できます。◎大型バス等をご利用のお客様は、サン予約センターまでメールまたはお電話にてお問い合わせください。◎本キャンペーンで取得した個人情報(メールアドレスを含む)は弊社以外の第三者に開示することはありません。◎予告無しにキャンペーンが変更になる場合があります。ご了承ください。</p>
